...
# python 3 SynDemons dos Script v.1.1-alpha
...
def user_agent():
	...
	uagent.append("Mozilla/5.0 (compatible; YandexBlogs/0.99; robot; B; +http://yandex.com/bots)")
	
	uagent.append("Mozilla/5.0 (compatible; MJ12bot/v1.4.5; http://www.majestic12.co.uk/bot.php?+)")
	
	uagent.append("Mozilla/5.0 (compatible; MSIE or Firefox mutant;) Daum 4.1, Mozilla/5.0 ")
	
	uagent.append("Mozilla/5.0 (compatible; BLEXBot/1.0; +http://webmeup-crawler.com/)")
	
	uagent.append("Mozilla/5.0 (Linux; Android 7.1.2; Pixel XL Build/NKG47M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/59.0.3071.125 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/135.0.0.22.90;]; WPEPF/1")
...
___________________________________
 ...
 ~1 NEw UAG
 ~2 NUCLEAR DDOS
 ~3 BOTNET + UAG + SYN %DANG
 ~4 Mock 
	  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-
	
	SYNDemons dos Script v.1.1-Ultra by ahura
